					...
					<div class="row fv-row">
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="carpeta_investigacion" name="carpeta_investigacion" value="{{ old('carpeta_investigacion', '') }}" placeholder="carpeta_investigacion" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="estatus_investigacion_id" name="estatus_investigacion_id" value="{{ old('estatus_investigacion_id', '') }}" placeholder="estatus_investigacion_id" class="form-control fw-bold" onkeyup="upper(this)" />
								<label for="estatus_investigacion_id">ESTATUS CARPETA DE INVESTIGACIÓN</label>
							</div>
						</div>
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="averiguacion_previa" name="averiguacion_previa" value="{{ old('averiguacion_previa', '') }}" placeholder="averiguacion_previa" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
						<div class="col-md-6 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<textarea id="delito" name="delito" value="{{ old('delito', '') }}" placeholder="delito" class="form-control fw-bold" style="height: 75px" onkeyup="upper(this)"></textarea>
						...
						<div class="col-md-6 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<textarea id="descripcion_delito" name="descripcion_delito" value="{{ old('descripcion_delito', '') }}" placeholder="descripcion_delito" class="form-control fw-bold" style="height: 75px" onkeyup="upper(this)"></textarea>
					...
					<div class="row fv-row">
						<div class="col-md-2 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="total_implicados" name="total_implicados" value="{{ old('total_implicados', '') }}" placeholder="total_implicados" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-2 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="fecha_hechos" name="fecha_hechos" value="{{ old('fecha_hechos', '') }}" placeholder="fecha_hechos" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-2 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="fecha_registro" name="fecha_registro" value="{{ old('fecha_registro', '') }}" placeholder="fecha_registro" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-6 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<textarea id="observaciones" name="observaciones" value="{{ old('observaciones', '') }}" placeholder="observaciones" class="form-control fw-bold" style="height: 75px" onkeyup="upper(this)"></textarea>

		...
		<div class="card card-flush h-xl-100">
			<div class="card-header pt-7">
				<h3 class="card-title align-items-start flex-column">
					...
					<span class="text-gray-400 mt-1 fw-semibold fs-6">Lista de Implicados</span>
				</h3>
							...
							@foreach($personas AS $persona)
								<tr>
									...
									<td class="text-end pe-0">
										<span class="text-gray-600 fw-bold fs-6">{{ $persona->alias }}</span>
									</td>
									<td class="text-end pe-0">
										<span class="text-gray-600 fw-bold fs-6">{{ $persona->rfc }}</span>
									</td>
									<td class="pe-0">
										<div class="d-flex align-items-center justify-content-end">
											...
											<span class="text-gray-600 fw-bold d-block fs-6">{{ $persona->curp }}</span>
										</div>
									</td>
									<td class="text-end pe-0">
										<span class="text-gray-600 fw-bold fs-6">{{ $persona->nacionalidad }}</span>
									</td>
									<td class="text-end">

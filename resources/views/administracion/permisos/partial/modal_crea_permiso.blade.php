	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<div class="modal-content">
			<div class="modal-header">
				<h2 class="fw-bold">Agregar Permiso</h2>
			...
			<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					...
					<div class="d-flex flex-stack flex-grow-1">
						<div class="fw-semibold">
							<div class="fs-6 text-gray-700">
								<strong class="me-1">¡Advertencia!</strong><br>
								Acrónimo del módulo es el sufijo del permiso<br>
								El permiso se indica en <span class="text-primary"><b>color azul</b></span> como se estableserá.
							</div>
						</div>
					</div>
				</div>
				...
				<form id="kt_modal_add_permission_form" class="form" action="#">
					...
					<div class="text-center pt-5">
						<button type="reset" class="btn btn-light me-3" data-kt-permissions-modal-action="cancel">Descartar Formulario</button>
						<button type="submit" class="btn btn-primary" data-kt-permissions-modal-action="submit">
							<span class="indicator-label">Crear Permiso</span>

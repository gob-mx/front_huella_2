<div class="modal fade" id="kt_modal_detalle" tabindex="-1" aria-hidden="true">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
				...
				<div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
					...
					<form id="kt_modal_detalle_form" class="form" method="post" action="{{ route('expediente.update',$expediente->id) }}">
					@method('PUT')
					<input type="hidden" name="_token" value="{{ csrf_token() }}" onkeyup="upper(this)" />

						<div class="col-md-12 text-center">
							<h1 class="label_carpeta">Registro Expediente {{ $expediente->id }}</h1>
							<h1 class="label_carpeta">CIB {{ str_pad($expediente->id, 10, '0', STR_PAD_LEFT) ?? '123456789QWERTY' }}</h1>
							<div class="text-muted fw-bold fs-5">Los campos con (<label class="required"></label> ) son obligatorios</div>
						</div>

						<div class="mb-5 border border-primary border-active active" style="border-radius: 25px;">
						...
						<div class="row py-5">
							<div class="col-md-7 offset-md-5">
								<div class="d-flex">
									...
									<button type="button" data-kt-ecommerce-settings-type="submit" data-index="{{ $expediente->id ?? '' }}" class="btn btn-primary" id="kt_modal_detalle_submit">

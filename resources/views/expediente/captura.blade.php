					...
					<div class="row fv-row">
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="nombre" name="nombre" value="{{ $persona->nombre ?? '' }}" placeholder="nombre" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="apellido_paterno" name="apellido_paterno" value="{{ $persona->apellido_paterno ?? '' }}" placeholder="apellido_paterno" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="apellido_materno" name="apellido_materno" value="{{ $persona->apellido_materno ?? '' }}" placeholder="apellido_materno" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
						<div class="col-md-2 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ $persona->fecha_nacimiento ?? '' }}" placeholder="fecha_nacimiento" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-3 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="sexo_id" name="sexo_id" placeholder="sexo_id" {{-- data-control="select2" --}}>
									...
									@foreach($sexo as $sx)
										@if(isset($persona->sexo_id) AND $persona->Sexo->id == $sx->id)
							...
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="estado_civil_id" name="estado_civil_id" placeholder="estado_civil_id" {{-- data-control="select2" --}}>
									...
									@foreach($estado_civil as $ec)
										@if(isset($persona->estado_civil_id) AND $persona->EstadoCivil->id == $ec->id)
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="curp" name="curp" value="{{ $persona->curp ?? '' }}" placeholder="curp" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
							...
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="nacionalidad_id" name="nacionalidad_id" placeholder="nacionalidad_id" {{-- data-control="select2" --}}>
									...
									@foreach($nacionalidad as $na)
										@if(isset($persona->nacionalidad_id) AND $persona->EstadoCivil->id == $na->id)
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="pais_nacimiento" name="pais_nacimiento" value="{{ $persona->pais_nacimiento ?? '' }}" placeholder="pais_nacimiento" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="entidad_nacimiento" name="entidad_nacimiento" value="{{ $persona->entidad_nacimiento ?? '' }}" placeholder="entidad_nacimiento" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="calle" name="calle" value="{{ $expediente->DomicilioDelito->calle ?? '' }}" placeholder="calle" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-2 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="numero_exterior" name="numero_exterior" value="{{ $expediente->DomicilioDelito->numero_exterior ?? '' }}" placeholder="numero_exterior" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-2 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="numero_interior" name="numero_interior" value="{{ $expediente->DomicilioDelito->numero_interior ?? '' }}" placeholder="numero_interior" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="colonia" name="colonia" value="{{ $expediente->DomicilioDelito->colonia ?? '' }}" placeholder="colonia" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
						<div class="col-md-3 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="delegacion_municipio" name="delegacion_municipio" value="{{ $expediente->DomicilioDelito->delegacion_municipio ?? '' }}" placeholder="delegacion_municipio" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-3 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="codigo_postal" name="codigo_postal" value="{{ $expediente->DomicilioDelito->codigo_postal ?? '' }}" placeholder="codigo_postal" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-3 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="ciudad" name="ciudad" value="{{ $expediente->DomicilioDelito->ciudad ?? '' }}" placeholder="ciudad" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-3 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="pais" name="pais" value="{{ $expediente->DomicilioDelito->pais ?? '' }}" placeholder="pais" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="peso" name="peso" value="{{ $expediente->DomicilioDelito->peso ?? '' }}" placeholder="peso" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="estatura" name="estatura" value="{{ $expediente->DomicilioDelito->estatura ?? '' }}" placeholder="estatura" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="senia_particular_id" name="senia_particular_id" placeholder="senia_particular_id" {{-- data-control="select2" --}}>
									<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ...Seleccione una Opción...</option>
									@foreach($senia_particular as $sp)
										@if(isset($persona->senia_particular_id) AND $persona->EstadoCivil->id == $sp->id)
					...
					<div class="row fv-row">
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="codigo_delito" name="codigo_delito" value="{{ $expediente->DomicilioDelito->codigo_delito ?? '' }}" placeholder="codigo_delito" class="form-control fw-bold" onkeyup="upper(this)" />
							...
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="tipo_registro_id" name="tipo_registro_id" placeholder="tipo_registro_id" {{-- data-control="select2" --}}>
									...
									@foreach($tipo_registro as $tr)
										@if(isset($expediente->tipo_registro_id) AND $expediente->EstadoCivil->id == $tr->id)
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="tipo_policia" name="tipo_policia" value="{{ $expediente->DomicilioDelito->tipo_policia ?? '' }}" placeholder="tipo_policia" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
							...
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="situacion_persona_id" name="situacion_persona_id" placeholder="situacion_persona_id" {{-- data-control="select2" --}}>
									...
									@foreach($situacion_persona as $sp)
										@if(isset($expediente->situacion_persona_id) AND $expediente->EstadoCivil->id == $sp->id)
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="informacion" name="informacion" value="{{ $expediente->DomicilioDelito->informacion ?? '' }}" placeholder="informacion" class="form-control fw-bold" onkeyup="upper(this)" />
							...
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="peligrosidad_id" name="peligrosidad_id" placeholder="peligrosidad_id" {{-- data-control="select2" --}}>
									...
									@foreach($peligrosidad as $pl)
										@if(isset($expediente->peligrosidad_id) AND $expediente->EstadoCivil->id == $pl->id)
					...
					<div class="row fv-row">
						<div class="col-md-2 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="fecha_ingreso" name="fecha_ingreso" value="{{ $persona->fecha_ingreso ?? '' }}" placeholder="fecha_ingreso" class="form-control fw-bold" onkeyup="upper(this)" />
							...
							<div class="form-floating ribbon ribbon-top">
								...
								<select class="form-select fw-bold pb-0" id="registros_nacionales_id" name="registros_nacionales_id" placeholder="registros_nacionales_id" {{-- data-control="select2" --}}>
									...
									@foreach($registros_nacionales as $rn)
										@if(isset($expediente->registros_nacionales_id) AND $expediente->EstadoCivil->id == $rn->id)
					...
					<div class="row fv-row">
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="clave_identificacion_1" name="clave_identificacion_1" value="{{ $expediente->DomicilioDelito->clave_identificacion_1 ?? '' }}" placeholder="clave_identificacion_1" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="clave_identificacion_2" name="clave_identificacion_2" value="{{ $expediente->DomicilioDelito->clave_identificacion_2 ?? '' }}" placeholder="clave_identificacion_2" class="form-control fw-bold" onkeyup="upper(this)" />
						...
						<div class="col-md-4 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<input type="text" id="clave_identificacion_3" name="clave_identificacion_3" value="{{ $expediente->DomicilioDelito->clave_identificacion_3 ?? '' }}" placeholder="clave_identificacion_3" class="form-control fw-bold" onkeyup="upper(this)" />
					...
					<div class="row fv-row">
						<div class="col-md-6 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<textarea id="contacto_agencia" name="contacto_agencia" placeholder="contacto_agencia" class="form-control fw-bold" style="height: 75px" onkeyup="upper(this)">{{ $carpeta->contacto_agencia ?? '' }}</textarea>
						...
						<div class="col-md-6 mb-7">
							<div class="form-floating ribbon ribbon-top">
								...
								<textarea id="comentarios" name="comentarios" placeholder="comentarios" class="form-control fw-bold" style="height: 75px" onkeyup="upper(this)">{{ $carpeta->comentarios ?? '' }}</textarea>

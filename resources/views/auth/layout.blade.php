...
@section('content')
    ...
    @if(setting('layout.type_auth')==='auth_1' || !setting('layout.type_auth'))
    ...
    @if(setting('layout.type_auth')==='auth_2')
    <!--begin::Authentication - Sign-in -->
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				<!--begin::Aside-->
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						...
						<!--end::Image-->
						<!--begin::Title-->
						<h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">¡Realiza tu Solicitud en línea!</h1>
						<!--end::Title-->
						<!--begin::Text-->
						<div class="text-gray-600 fs-base text-center fw-semibold col-9">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ratione excepturi debitis rem quaerat quas explicabo autem cupiditate ipsam aut, praesentium voluptate, laboriosam vero ipsa? Ipsam quis soluta consectetur iure accusamus.
                        </div>
						<!--end::Text-->
					</div>
					<!--end::Content-->
				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
					<!--begin::Wrapper-->
					<div class="bg-body d-flex flex-center rounded-4 w-md-800px p-10">
						<!--begin::Content-->
    ...
    @if(setting('layout.type_auth')==='auth_3')

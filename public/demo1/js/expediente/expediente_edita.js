...
// Class definition
var KTExpedienteEdita = function () {
	// Private variables
	var form;
	var submitButton;
	var validation;
	...
	var handleForm = function () {
		submitButton.addEventListener('click', function (e) {
			...
			var expediente_id = $(this).attr('data-index');

			// Validate form
			validation.validate().then(function (status) {
				if (status === 'Valid') {

					var dataForm = $('#kt_modal_detalle_form').serialize();
					...
					$.ajax({
						...
						url: base_url + 'expediente/'+expediente_id,
						type: 'PUT',
						dataType: 'JSON',
						data: dataForm,
						beforeSend: function() {
	...
	return {
		init: function () {
			form = document.getElementById('kt_modal_detalle_form');
			submitButton = form.querySelector('#kt_modal_detalle_submit');
